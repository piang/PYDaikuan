...
@implementation DKNewsTableViewCell

+ (instancetype)cellWithTableView:(UITableView *)tableView {
    static NSString *newsTableViewCellIdentifier = @"newsTableViewCellIdentifier";
    
    DKNewsTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:newsTableViewCellIdentifier];
    
    if (cell == nil) {
        cell = [[DKNewsTableViewCell alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:newsTableViewCellIdentifier];
    }
